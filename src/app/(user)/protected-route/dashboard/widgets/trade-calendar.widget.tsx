        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div>
            <DayPicker
              ...
              className={cn(
                "bg-card h-96 md:h-full lg:h-full group/calendar border rounded-lg p-3 [--cell-size:--spacing(8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
